...
@$submit=$_POST["send"];
@$nom=$_POST["nom"];
@$simple=$_POST["nbsimple"];
@$double=$_POST["nbdouble"];
...
if(isset($submit)){
	try{
		...
		$req=$pdo->prepare("insert into hotel values('','".$double."','"
			.$simple."','".$nom."');");
		$req->execute();
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i>Add a hotel</h4>
							...
							<div class="widget-content ">
									<div class="form-group">
										...
										<div class="col-md-9">
                                             <input type="text" name="nom" class="form-control required" placeholder="Nom Hotel" autofocus="autofocus" data-rule-required="true">						
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Double room N° </label>
										<div class="col-md-9">
											<input type="text" name="nbdouble" class="form-control required" placeholder="0" autofocus="autofocus" data-rule-required="true">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Single room N° </label>
										<div class="col-md-9">
											 <input type="text" name="nbsimple" class="form-control required" placeholder="0" autofocus="autofocus" data-rule-required="true">
										</div>
									</div>
