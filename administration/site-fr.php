...
<html>
<head>
	<?php $titleADMIN="Panneau d'Administration | Configuration du site web francais"; include 'head.php'; ?>
</head>
<body>
<header>
  ...
  <div class="main">
        ...
        <div class="grid-1">
           <div class="title-grid">Informations generales</div>
		...
		<!--Article 4-->
		        <!--CFP-->
        <div class="grid-1">
           <div class="title-grid">L'appel pour papier | CFP</div>
           <div class="content-gird">
           <div class="form">
           		<div class="elem">
                 ...
                 <div class="elem">
                        <label>Programme de l'evenemet | Partie 1</label>
                        <div class="indent">
		...
		<!--CFP-->
		        <!--Gallerie-->
        <div class="grid-1">
           <div class="title-grid">La Gallerie photos :</div>
           <div class="content-gird">
           <div class="form">
           		<div class="elem">
                        <label>Photo 1 :</label>
		...
		<!--Gallerie-->
				        <!--Contact-->
        <div class="grid-1">
           <div class="title-grid">Contacts :</div>
           <div class="content-gird">
           <div class="form">
           		<div class="elem">
                        <label>Email :</label>
