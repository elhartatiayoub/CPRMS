...
try{
	...
	$req=$pdo->prepare("select * from hotel;");
				...
				<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i>List of Hotels</h4>
							...
							<div class="widget-content no-padding">
								<table class="table table-hover table-striped table-bordered table-highlight-head">
									<thead>
											<tr>
												<th >Nom</th>
												<th >Nombre de chambres simples vides</th>
												<th >Nombre de chambres doubles vides</th>
												<th>Delete</th>
									...
									<tbody>
										<?php for($i=0;$i<count($hotel);$i++) {
											?>
											<tr class="item">
												<td class="subject"><?php echo $hotel[$i]["nom"]?></td>
												<td><span class="published"><?php echo $hotel[$i]["nbSimple"]?></span></td>
												<td><?php echo $hotel[$i]["nbDouble"]?></td>
												<td class="action"><a href='deleteau.php?id=<?php echo $hotel[$i]["ID"]?>'><img src="images/del.png" alt="delete"></a></td>
											</tr>
										<?php }?>
										</tbody>
							</div>
