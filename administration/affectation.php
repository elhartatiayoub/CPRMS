...
try{
	...
	$req=$pdo->prepare("select * from soumission where etat=0;");
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-content">
								...
								<form class="form-horizontal row-border" action="envoyerdemande.php" method="post">
									<div class="form-group">
										<label class="col-md-3 control-label">Not Affected articles </label>
										<div class="col-md-9">
											 <select class="col-md-12 select2 full-width-fix required" name="article"> 
											 <?php for($i=0;$i<count($soumission);$i++){?>
												<option value="<?php echo $soumission[$i]["Id"]?>"><?php echo $soumission[$i]["article"]?></option>
												<?php }?>
											</select>   
									    </div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Comitee Members </label>
										<div class="col-md-9">
											<select class="col-md-12 select2 full-width-fix required"  name="membre"> 
												 <?php for($i=0;$i<count($membre);$i++){?>
													<option value="<?php echo $membre[$i]["ID"]?>"><?php echo $membre[$i]["nom"]." ".$membre[$i]["nom"]?></option>
													<?php }?>
											</select>
