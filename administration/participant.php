...
try{
	...
	$req=$pdo->prepare("select * from participant;");
								...
								<table class="table table-hover table-striped table-bordered table-highlight-head">
									...
									<tbody>
										<?php for($i=0;$i<count($participant);$i++) {
											?>
											<tr class="item">
												<td class="subject"><?php echo $participant[$i]["nom"]?></td>
												<td><span class="published"><?php echo $participant[$i]["prenom"]?></span></td>
												<td><?php echo $participant[$i]["email"]?></td>
												<td class="name"><?php echo $participant[$i]["adresse"]?></td>
												<td class="name"><?php echo $participant[$i]["tel"]?></td>
												<td><?php echo $participant[$i]["laboratoire"]?></td>
												<td class="name"><?php echo $participant[$i]["equipeTravaille"]?></td>
												<td class="name">Principal</td>
												<td class="action"><a href='deleteau.php?id=<?php echo $participant[$i]["ID"]?>'><img src="images/del.png" alt="delete"></a></td>
											</tr>
											<?php }?>
